...
<a role="button" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" href="<?php echo base_url();?>admin/objectius_projecte/add">
	...
	<span class="ui-button-text">Agregar Objectius estrategics</span>
</a>
</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="groceryCrudTable">
	...
	<tbody>
		  ...
		  <?php foreach($data as $row){ ?>
			<tr id='row-0'>
				<td><?php echo $row->objectiu;?> </td>
				<td><?php echo $row->descripcio;?></td>
			
				<td class='actions'>
				<a href="<?php echo base_url();?>admin/objectius_estrategics/edit/<?php echo $row->id;?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
				<span class="ui-button-icon-primary ui-icon ui-icon-pencil"></span>
				<span class="ui-button-text">&nbsp;Editar</span>
				</a>
				<a onclick = "javascript: return delete_row('<?php echo base_url();?>admin/principis_estrategies/delete/<?php echo $row->id;?>', '0')" 
