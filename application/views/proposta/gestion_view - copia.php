...
<div class="contenttitle2">
    <h3>Listat de propostes</h3>
</div><!--contenttitle-->
            
 
<br>

  <form name="myform3"  id="myform3" action="<?php echo base_url().'proyecto/delete_all';?>"; method="post">
    ...
    <tbody >
      ...
      <?php foreach ($data as $row2):?> 	
       <tr class="gradeX">
          ...
          <td width="10"><a href=""> <?php echo $i;?></a></td>
	      <td width="200"><a href=""> <?php echo $row2->titol;?></a></td>
	      <td width="200"><a href=""> <?php echo $row2->data;?></a></td>
	      <td alig="center" width="200">
			<a href="#" title="Ver"class="btn btn3 btn_search"></a> 
			<a href="#" title="Editar"class="btn btn3 btn_flag">
...
function ajaxUpdate(id,i){
	...
	document.location = '<?php echo base_url().'proposta/update/'?>'+'/'+<?php echo $id_seccion;?>+'/'+id+'/'+dato; 
}
</script>
 <script type="text/javascript" language="javascript">
function ajaxEliminar(id1,id2){
	if (confirm("¿Está seguro que desea realizar esta acción?")) {
         document.location = '<?php echo base_url().'proposta/delete'?>'+'/'+id1+'/'+id2;
      };	
}
</script>
