...
<h1 class="pagetitle">Projectes</h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
    ...
    <thead>
        ...
        <tr>
            ...
            <th class="head1">Data entrega</th>
            <th class="head0 nosort">Acció</th>
            <th class="head0 nosort">Estat</th>
         
        </tr>
    </thead>
    <tbody >
  
      <?php if (!empty($proyectos)){$i=1;?>
      <?php foreach ($proyectos as $row2):?> 	
       <tr class="gradeX">
          <td align="center" >
	          <span class="center">
	      ...
	      <td width="200"><a href=""> <?php echo $row2->data_entrega;?></a></td>
