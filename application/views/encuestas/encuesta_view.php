...
<div class='form-content form-div'>
	<form action="<?php echo base_url();?>admin/encuesta/insert" method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data" accept-charset="utf8">		<div>
				...
				<div class='form-input-box' id="resultado_input_box">
					<select id='field-resultado' name='resultado' class='chosen-select' data-placeholder='Select Resultado'><option value=''  ></option><option value='0'  >1</option><option value='1'  >2</option><option value='2'  >3</option><option value='3'  >4</option><option value='4'  >5</option><option value='5'  >6</option><option value='6'  >7</option><option value='7'  >8</option><option value='8'  >9</option><option value='9'  >10</option></select>				</div>
				<div class='clear'></div>	
			</div>
