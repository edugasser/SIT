...
<div class="contenttitle2">
    <h3>Listat de departaments</h3>
</div><!--contenttitle-->
            
 
<br>

  <form name="myform3"  id="myform3" action="<?php echo base_url().'departament/delete_all';?>"; method="post">
    ...
    <tbody >
      ...
      <?php foreach ($data as $row2):?> 	
       <tr class="gradeX">
	      ...
	      <td width="200"><a href=""> <?php echo $row2->dept;?></a></td>
...
function ajaxUpdate(id,i){
	...
	document.location = '<?php echo base_url().'departament//update/'?>'+'/'+<?php echo $id_seccion;?>+'/'+id+'/'+dato; 
}
</script>
 <script type="text/javascript" language="javascript">
function ajaxEliminar(id1,id2){
	if (confirm("¿Está seguro que desea realizar esta acción?")) {
         document.location = '<?php echo base_url().'departament//delete'?>'+'/'+id1+'/'+id2;
      };	
}
</script>
