 ...
 **************************************************************************/
	...
	$tcpdf['header_font_size'] = 15;
	$tcpdf['header_margin'] = 6;
	$tcpdf['header_title'] = '';
	$tcpdf['header_string'] = "";
	$tcpdf['header_logo'] = 'ccm_logo.png';
	$tcpdf['header_logo_width'] = 40;
		// $tcpdf['header_on'] = TRUE;
	// $tcpdf['header_font'] = $tcpdf['page_font'];
	// $tcpdf['header_font_size'] = 2;
	// $tcpdf['header_margin'] = 1;
	// $tcpdf['header_title'] = '';
	// $tcpdf['header_string'] = "";
	// $tcpdf['header_logo'] = '';
