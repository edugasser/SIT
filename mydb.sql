...
--
-- Servidor: localhost
-- Tiempo de generación: 19-12-2012 a las 08:15:25
...
('a1be1ccf5537cb9bb5b8c0ace95f009b', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/536.26.17 (KHTML, like Gecko) Version/6.0.2 Safari/536.26.17', 1355904783, ),
('e0619e49caeb5eda49a6b1cd605bf3f1', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:14.0) Gecko/20100101 Firefox/14.0.1', 1355904625, );
...
(3, 'Nueva enquesta', '2012-12-11', 25);
...
(1, 'incidencia 1', '<p>\n	asd asd</p>\n', '2012-12-19', 'Oberta', 'Alta', '<p>\n	asd asd s</p>\n', 1),
(2, 'incidencia 2', '<p>\n	as ds</p>\n', '2013-03-15', 'Tancada', 'Alta', '<p>\n	as sds</p>\n', 2),
(3, 'Incidencia 2', '', '2012-12-15', 'Tancada', 'Mitja', '', 1),
(4, 'Incidencia 3', '', '2013-01-01', 'Tancada', 'Baixa', '', 1),
(5, 'Incidencia 4', '', '2013-02-01', 'Tancada', 'Mitja', '', 1),
(6, 'Incidencia nueva', '<p>\n	asdfs</p>\n', '2013-02-13', 'Tancada', 'Mitja', '', 2),
(7, 'Incidencia nueva', '', '2013-02-01', 'Tancada', 'Alta', '', 2),
(8, 'Otra incidencia', '<p>\n	Otra incidencia</p>\n', '2013-04-12', 'Tancada', 'Alta', '', 1);
...
--
-- Estructura de tabla para la tabla `persona_proposta`
--

CREATE TABLE IF NOT EXISTS `persona_proposta` (
  `id_persona_proposta` int(2) NOT NULL AUTO_INCREMENT,
  `id_persona` int(2) NOT NULL,
  `id_proposta` int(2) NOT NULL,
  PRIMARY KEY (`id_persona_proposta`),
  KEY `id_proposta` (`id_proposta`),
  KEY `id_persona` (`id_persona`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Volcar la base de datos para la tabla `persona_proposta`
--

INSERT INTO `persona_proposta` (`id_persona_proposta`, `id_persona`, `id_proposta`) VALUES
(1, 1, 15),
(2, 5, 15);
...
(25, 'Tutoria / Soporte remoto', 'El soporte remoto ¡es una solución ideal para el personal de IT que busca asistir a sus clientes remotamente y a la vez ahorrar tiempo y dinero.', '2012-12-01', '1000', '1000', '2012-12-31', 14, 6, 'Mitja', 3, 3, 0),
(26, 'Arquitectura Moodle', 'Renovar la arquitectura Moodle.', '2012-12-13', '3000', '3000', '2012-12-16', 14, 3, 'Baixa', 2, 1, 1),
(27, 'Control de acceso', 'Sistemas para control de acceso con lector de huella digital, clave y tarjeta inteligente', '2012-12-01', '2050', '2050', '2013-01-01', 14, 6, 'Alta', 3, 3, 1),
...
(2, 'admin', '$2a$08$Fc8ch.9YrFlD7TvlDa8u/ejOERQRjRrpxsNEgTZMponx/I6x3vW3e', 'edugasser@gmail.com', 1, 0, NULL, NULL, NULL, NULL, NULL, '::1', '2012-12-19 08:10:29', '2012-12-10 18:00:57', '2012-12-19 09:10:29', 1),
...
--
-- Filtros para la tabla `persona_proposta`
--
ALTER TABLE `persona_proposta`
  ADD CONSTRAINT `persona_proposta_ibfk_2` FOREIGN KEY (`id_proposta`) REFERENCES `proposta` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `persona_proposta_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persones` (`id_persona`) ON DELETE CASCADE ON UPDATE CASCADE;
