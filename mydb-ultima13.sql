...
--
-- Servidor: localhost
-- Tiempo de generación: 13-12-2012 a las 17:13:28
...
('0a01abf518754f2e40bf683f15a81998', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/536.26.17 (KHTML, like Gecko) Version/6.0.2 Safari/536.26.17', 1355407810, ),
('340470c299b02b6ebdf8e6c95c65b0a7', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:14.0) Gecko/20100101 Firefox/14.0.1', 1355406331, ),
('dc7bf6d50f657d56afd459531a7b48c9', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.97 Safari/537.11', 1355406324, );
...
--
-- Volcar la base de datos para la tabla `decisio`
--
...
CREATE TABLE IF NOT EXISTS `projecte` (
  ...
  `id_objectiu_tactic` int(2) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `id_objectiu_tactic` (`id_objectiu_tactic`),
  KEY `id_objectiu_tactic_2` (`id_objectiu_tactic`)
...
INSERT INTO `projecte` (`id`, `titol`, `descripcio`, `data_inici`, `pressupost_inicial`, `pressupost_final`, `data_entrega`, `Proposta_id`, `Seguiment_projecte_id`, `estat_projecte`, `data_registre`, `id_responsable`, `id_objectiu_tactic`) VALUES
(2, 'Práctica de SIT', 'Realizar una práctica de SIT', '2012-12-05', '232', '2342', '2012-12-20', NULL, NULL, 4, '0000-00-00 00:00:00', 1, 1),
(7, 'Un proyecto', 'asdfa ', '2012-12-05', '212342', '2342', '2012-12-21', NULL, NULL, 1, '2012-12-04 00:00:00', 1, 1);
...
(2, 'admin', '$2a$08$Fc8ch.9YrFlD7TvlDa8u/ejOERQRjRrpxsNEgTZMponx/I6x3vW3e', 'edugasser@gmail.com', 1, 0, NULL, NULL, NULL, NULL, NULL, '::1', '2012-12-13 13:45:36', '2012-12-10 18:00:57', '2012-12-13 14:45:36', 1);
...
ALTER TABLE `projecte`
  ...
  ADD CONSTRAINT `projecte_ibfk_2` FOREIGN KEY (`id_responsable`) REFERENCES `persones` (`id_persona`),
  ADD CONSTRAINT `projecte_ibfk_3` FOREIGN KEY (`id_objectiu_tactic`) REFERENCES `objectius_tactics` (`id`);
